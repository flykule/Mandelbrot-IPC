...
Worker::Worker(QObject *parent)
    : QObject(parent), mSocket(this), mSocketReader(&mSocket),
      mReceivedJobsCounter(0), mSentJobsCounter(0) {
...
void Worker::sendUnregister() {
  MessageUtils::sendMessage(mSocket, Message::Type::WORKER_UNREGISTER, true);
}

int Worker::sentJobsCounter() const { return mSentJobsCounter; }

int Worker::receivedJobsCounter() const { return mReceivedJobsCounter; }
